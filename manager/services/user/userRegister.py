...
class UserRegister:
    ...
    def _create_user(self, user_email, user_password):
        query = f'INSERT INTO representante ' \
                f'(emailrepresentante, senharepresentante)  ' \
                f'VALUES ({user_email}, {user_password})'
    ...
    def process(self):
        ...
        try:
            ...
            return 'Registration sucessful! Now you are able to perform login'
